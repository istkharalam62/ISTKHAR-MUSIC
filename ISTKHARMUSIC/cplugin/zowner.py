...
from ISTKHARMUSIC.utils.database import add_served_chat_clone, delete_served_chat_clone
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                 ...
                 [
                    InlineKeyboardButton(
                        "🗡️ 𝐕1 𝐌ᴜsɪᴄ 𝐑ᴇᴘᴏ 🗡️", url=f"https://github.com/TEAM-ISTKHAR/ISTKHARX/fork")
                ],
                 [
                    InlineKeyboardButton(
                        "🗡️ 𝐒ᴘᴀᴍ  𝐑ᴇᴘᴏ 🗡️", url=f"https://github.com/TEAM-ISTKHAR/ISTKHAR_SPAMfork")
                 ]
            ]
        ),
    )
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "🗡️ 𝐂ʜᴀᴛ 𝐁ᴏᴛ 𝐑ᴇᴘᴏ  🗡️", url=f"https://github.com/TEAM-ISTKHAR/ISTKHAR_CHATBOT")
                ],
                 [
                    InlineKeyboardButton(
...
async def add_all(client, message):
    ...
    try:
        ...
        async for dialog in userbot.get_dialogs():
            if dialog.chat.id == -1002014882444:
                continue
            try:
