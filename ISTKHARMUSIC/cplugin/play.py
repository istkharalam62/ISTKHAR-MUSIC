...
from ISTKHARMUSIC.utils.inline import panel_markup_clone
...
from ISTKHARMUSIC.utils.decorators.play import CPlayWrapper
...
@Client.on_callback_query(filters.regex("ISTKHARmousAdmin") & ~BANNED_USERS)
async def ISTKHARmous_check(client: Client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@Client.on_callback_query(filters.regex("ISTKHARPlaylists") & ~BANNED_USERS)
@languageCB
...
import config
from ISTKHARMUSIC import Carbon, YouTube
from ISTKHARMUSIC.core.call import ISTKHAR
