...
from ISTKHARMUSIC.utils import close_markup
from config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from ISTKHARMUSIC import Carbon, app
from ISTKHARMUSIC.utils.decorators.language import language, languageCB
from ISTKHARMUSIC.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
...
async def add_playlist_clone(client: Client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from ISTKHARMUSIC import YouTube
...
@Client.on_callback_query(filters.regex("ISTKHAR_playlist") & ~BANNED_USERS)
@languageCB
